...
<head>
    ...
    <title>TA Andika</title>

    <!-- Bootstrap CSS CDN -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.0/css/bootstrap.min.css" integrity="sha384-9gVQ4dYFwwWSjIDZnLEWnxCjeSWFphJiwGPXr1jddIhOegiu1FwO5qRGvFXOdJZ4" crossorigin="anonymous">
    <!-- Our Custom CSS -->
    <link rel="stylesheet" href="css/style2.css">
    <!-- Scrollbar Custom CSS for second style2.css -->
...
<body>
    <div class="wrapper">
        <nav id="sidebar">
            <div class="sidebar-header">
                    <h3><i class="fas fa-user" style="color:#fafafa"></i> Andika</h3>
            </div>
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu">
                        ...
                        <li>
                            <a href="index.php?page=Remote">Remote</a>
                        </li>
                        <li>
                            <a href="index.php?page=Power">Power</a>
                        </li>
                    </ul>
                </li>
                <li>
    ...
    <!-- jQuery Custom Scroller CDN for second style2.css -->
